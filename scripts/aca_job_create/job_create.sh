az containerapp job create -n "$ACA_JOB_NAME" -g "$ACA_RESOURCE_GROUP" --environment "$ACA_ENVIRONMENT" \
        ...
        --env-vars "PRIVATE_KEY=secretref:app-key" "GH_URL=https://github.com/$ORG_NAME" "REGISTRATION_TOKEN_API_URL=https://api.github.com/orgs/$ORG_NAME/actions/runners/registration-token" "LABELS=$LABELS" "GH_APP_CLIENT_ID=$GH_APP_CLIENT_ID" "GH_APP_INSTALLATION_ID=$GH_APP_INSTALLATION_ID"\
